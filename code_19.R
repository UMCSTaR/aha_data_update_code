...
aha_18 <- read.csv("X:/George_Surgeon_Projects/standardized_medicare_data_using_R/input/aha_hosp_05_18.csv") %>% select(-X)

#read aha file for new year
aha_19 <- read_sas("X:/Resources/Provider/AHA_American_Hosp_Assoc_Survey/SAS_Data_Files/AHA2019/AS2019PUB.sas7bdat")
