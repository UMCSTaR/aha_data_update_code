...
aha_19 <- read.csv("X:/George_Surgeon_Projects/standardized_medicare_data_using_R/input/aha_hosp_05_19.csv") 

#read aha file for new year
aha_20 <- read_sas("X:/Resources/Provider/AHA_American_Hosp_Assoc_Survey/SAS_Data_Files/AHA2020/aha2020.sas7bdat")
...
aha_hosp_05_20 <- rbind(aha_19,aha_new) 
aha_hosp_05_20$PRVNUMGRP = as.character(aha_hosp_05_20$PRVNUMGRP)

fwrite(aha_hosp_05_20,"X:/George_Surgeon_Projects/standardized_medicare_data_using_R/input/aha_hosp_05_20.csv")
